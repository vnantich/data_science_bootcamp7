reservation_bot <- function() {
     welcome = readline ("Welcome to Ichi Ni San Udon, your go-to place for homemade udon! How can we assist you today? 
        ...
        if ( welcome == "1") {
            ...
            cat(paste("Thank you for choosing Ichi Ni San Udon! Your reservation for" ,datetime, "has been confirmed."))
            }
        else if (welcome == "2"){
                cat("1. Spicy Beef Udon priced at 245 baht: Flank steak cut into cubes, served with our house-made spicy beef broth.
